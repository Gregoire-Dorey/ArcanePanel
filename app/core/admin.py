...
class CheckResultAdmin(admin.ModelAdmin):
    list_display = ("check", "ok", "latency_ms", "recorded_at")
    list_filter = ("ok", "recorded_at")
    search_fields = ("check__name", "check__asset__name")

@admin.register(Alert)
class AlertAdmin(admin.ModelAdmin):
    list_display = ("title", "check", "severity", "is_open", "opened_at", "closed_at", "ack_by")
    list_filter = ("severity", "is_open")
    search_fields = ("title", "check__name", "check__asset__name")
